...
function addPreviews(previews, widgetName) {
    previews[widgetName].callback = MathJax.Callback(["CreatePreview", previews[widgetName]]);
    previews[widgetName].callback.autoReset = true;  // make sure it can run more than once
    previews[widgetName].Update();
}